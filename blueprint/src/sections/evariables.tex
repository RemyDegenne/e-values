...
\begin{proof}
It suffices to find a sequence of measurable functions $\tilde{X}_n$ and an $X$ such that $\tilde{X}_n \to X$ in probability, since we can then obtain a.e. convergence for a sub-sequence (Mathlib's lemma \href{https://leanprover-community.github.io/mathlib4_docs/Mathlib/MeasureTheory/Function/ConvergenceInMeasure.html#MeasureTheory.TendstoInMeasure.exists_seq_tendsto_ae}{TendstoInMeasure.exists\_seq\_tendsto\_ae}).
